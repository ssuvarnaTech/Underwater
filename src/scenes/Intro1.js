class Intro2 extends Phaser.Scene{
    ...
    create(){
        ...
        this.add.text(game.config.width/2, game.config.height/2 - borderUISize - 
            borderPadding, "Save Ariel from Ursula's Cave.", menuConfig).setOrigin(0.5);
            this.add.text(game.config.width/2, game.config.height/2 - borderUISize - 
              borderPadding + 100, "She wants to get back to her Prince.", menuConfig).setOrigin(0.5);
        this.add.text(game.config.width/2, game.config.height/2 - borderUISize - 
            borderPadding + 200, "Press S to start the game", menuConfig).setOrigin(0.5);   
        console.log('hi');
